...
-- 1. Drop the old check constraints FIRST (they still only allow 'travel').
...
-- 2. Migrate existing 'travel' rows to 'travel_fares'.
...
-- 3. Add the expanded check constraints.
...
-- 4. Ensure every plan has all seven permanent annual-grant rows.
